...
public:
  ...
  // Move assignment
  Stack<Data>& operator=(Stack<Data>&&)=delete; // Move assignment of abstract types is not possible.

  /* ************************************************************************ */

  // Comparison operators
  bool operator==(const Stack<Data>&)=delete; // Comparison of abstract types is not possible.
  bool operator!=(const Stack<Data>&)=delete; // Comparison of abstract types is not possible.
